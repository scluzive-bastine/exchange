    ...
    <div class="container mb-8">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8 text-center justify-center text-white">
                <h5 class="text-2xl mb-3">Confirm Details</h5>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-8 mb-5">
                <div class="container p-0">
                    <div class="bg-white text-gray-600 rounded exchange--container shadow-lg">
                        <h5>Please <span class="section__change--title">Confirm</span> the details of your transaction</h5>
                        <div class="confirm__section--one">
                            ...
                            <form action="">
                                ...
                                <div class="exchange__input--calculator flex mt-3 rounded">
                                    ...
                                    <div class="select__coin-option recieve__coin--option flex px-1 rounded-tr-md rounded-br-md">
                                        {{-- <button class="btn btn-primary">BTC <i class="fa fa-dropbox    "></i> </button> --}}
                                        <div class="flex coin__symbol--icon justify-content-center">
                                ...
                                <div class="recipient__address--container mt-4">
                                    ...
                                    <div class="input__box-container receiveAddress mt-2 px-2 rounded flex">
                                        <div class="" style="width: 95%">
                                            <label for="address" class="mb-0 mt-2">Enter the <span class="coinRec uppercase">{{ $recieveCoin }} </span> address</label>
                                            <input type="text" class="form-control ex__input--address pb-0" name="recieveAddress" id="ex__input--address" value="">
                                        </div>
                                        <span class="ml-auto input__check" style="font-size: 1.2rem;margin-top: 2.1rem">
                                ...
                                <div class="input__box-container refund__box--container mt-2 px-2 rounded flex">
                                    <div class="" style="width: 95%">
                                        <label class="refundLabel mt-2" for="address" class="mb-0" style="margin-bottom: 0!important;">Enter your <span class="sendCoin uppercase">{{$sendCoin}} </span>address in case of refund</label>
                                        <div class="mt-0 text-red-500 text-small addressError"></div>
                                        <input type="text" class="form-control ex__input--address refundAddress pb-0" name="refundAddress" value="">
                                    </div>
                        ...
                        <div class="confirm__section--two mt-4 text-blue-800" style="display: none">
                            {{-- <form action="{{ route('exchange.confirm') }} " method="POST" id="instantForm"> --}}
                                ...
                                <div class="send__coin--amount">
                                    <h6>You Send</h6>
                                    <h1 class="font-bold text-blue-900 text-3xl mt-1 mb-1"> <span class="coinSendAmount text-blue-900"> {{$sendAmount}} </span> <span class="coinSendSymbol uppercase text-blue-900"> {{ $sendCoin }} </span> </h1>
                                    <h6>
                                        <span class="coinSendAmount text-blue-900">{{$sendAmount}}</span> <span class="coinSendSymbol uppercase text-blue-900"> {{$sendCoin}} </span> ≈ <span class="coinRecieveAmount text-blue-900"></span> <span class="coinRecieveSymbol uppercase text-blue-900"> {{ $recieveCoin }} </span>
                                    </h6>
                                ...
                                <div class="recieve__coin--amount mt-4">
                                    <h6>You Get</h6>
                                    <h1 class="font-bold text-blue-900 text-3xl mt-1 mb-1"> ≈ <span class="coinRecieveAmount text-blue-900"></span> <span class="coinRecieveSymbol uppercase text-blue-900"> {{ $recieveCoin }} </span> </h1>
                                ...
                                <div class="policy__container--approval mt-4">
                                    <div class="flex">
                                        <input type="checkbox" checked class="mt-1 mr-2" name="" id="">
                            ...
                            <div class="confirm__button mt-4 flex">
                                ...
                                <button class="btn btn-primary btn-confirm-transaction btn-custom px-5 lg:px-16 sm:px-8 py-2 btn-confirm">
                        ...
                        <div class="confirm__section--three" style="display: none">
                            <div class="send__amount--container">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control coinSendAddress px-0" value="" style="font-size:25px; background: transparent; border: 0;" readonly>
                            ...
                            <div class="send__warning mt-2 px-2 py-2 bg-gray-400 text-blue-800 rounded lg:w-75 sm:w-100">
                            ...
                            <div class="text-center mt-4">
                                ...
                                <div class="completed_transaction bg-teal-700 text-white text-3xl text-center ml-auto mr-auto d-none" style="width: 50px; height: 50px; border-radius: 50%;">
                                    <i class="fa fa-check mt-2" aria-hidden="true"></i>
                                </div>
...
<script type="text/javascript">
    ...
    function checkAddress() {
        ...
        function thirdSection() {
            ...
            var completedTransaction = function() {
                var url = ' {{ route('new.exchange') }} ';
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(status == 'finished') {
                            ...
                            $('.completed_transaction').removeClass('d-none');
                            $('.completed_transaction').show();
                            $('.lds-ripple').hide();
                            delay(completedTransaction(), 9000);
    ...
    function transactionSuccessful(transactionId) {
        $.ajax({
            type: 'POST',
            url: '{{ route('bs.exchange.success') }}',
            data: $('#exchangeSuccessfulForm').serialize(),
            success: function() {
                console.log('success');
                var url = ' {{ route('exchange.finished', ':id') }} ';
                url = url.replace(':id', transactionId);
                window.location = url;
            }, 
            error: function(xhr, status, error) {
