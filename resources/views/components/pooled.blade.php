...
@section('content')
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-md-6">
                    <h1 class="display-2 mb-4">Pooled<span class="text-secondary-app font-weight-bold"> Staking</span>
                    </h1>
                    ...
                    <div class="d-flex flex-wrap mt-4 mt-lg-5">
                        <a href="./html/components/all.html" class="btn btn-tertiary mb-3 mt-2 mr-2 mr-md-3 animate-up-2">
                            <span class="fas fa-coins mr-2"></span> Starting Staking
                        </a>
                    </div>
                </div>
                <div class="col-12 col-md-6 text-center">
                    <img class="d-none d-md-inline-block" src="/images/pooled.svg" alt="Mobile App Mockup">
                </div>
            </div>
        </div>
    ...
    <section class="section section-lg bg-primary py-sm-0" style="margin-bottom: -11rem;">
        <div class="container z-2 mt-sm-n6 mt-md-n7">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="card bg-white border-light text-gray p-4">
                        <div class="card-header bg-white border-0 pb-0">
                            <h2 class="h4 m-0">Share Moments that Matter</h2>
                        </div>
                        <div class="card-body">
                            <p>
                                Send photos and videos instantly. You can even capture the moments that matter to you most with a built-in camera.                           
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="card bg-white border-light text-gray p-4">
                        <div class="card-header bg-white border-0 pb-0">
                            <h2 class="h4 m-0">Speak Freely to your Friends</h2>
                        </div>
                        <div class="card-body">
                            <p>
                                With voice calls, you can talk to your friends and family for free*, even if they're in another country or another continent.                          
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-6">    
                    <div class="d-flex flex-wrap justify-content-lg-start">
                        <h2 class="h3 text-center text-lg-left mb-5">Pooled Staking</h2>
                        <div class="my-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h3 class="h4">Security by default</h3>
                                    <p>
                        ...
                        <div class="my-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h3 class="h4">Groups to keep in touch</h3>
                                    <p>
                        ...
                        <div class="my-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h3 class="h4">Document Sharing Made Easy</h3>
                                    <p>
                ...
                <div class="col-12 col-lg-5">
                    <img class="d-none d-lg-inline-block" src="/images/pool-content.svg" alt="pool contents">
                </div>
            </div>
        </div>
    </div>
    <section class="section bg-secondary text-white">
        <div class="container text-center">
            <h4 class="h1">Statistics</h4>
            <h1 class="mt-4 font-bold">$12,121</h1>
            <span class="lead uppercase" style="font-size: .8rem">Total Staked</span>
        </div>
    </section>
